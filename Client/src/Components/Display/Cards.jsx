  ...
  return (
    <>
      <div
        ...
        className="bg-[#1E1F20] p-[16px] hover:bg-[#333537] cursor-pointer flex flex-col justify-between text-white text-sm md:w-[195px] md:h-[195px] w-[165px] h-[165px] text-left rounded-[12px]"
      >
      ...
      <div
        ...
        className="bg-[#1E1F20] p-[16px] hover:bg-[#333537] flex flex-col justify-between cursor-pointer text-white text-sm md:w-[195px] md:h-[195px] w-[165px] h-[165px] text-left  rounded-[12px]"
      >
        <div className="text-[16px] md:text-[18px]">
