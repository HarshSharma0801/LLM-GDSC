const Display = () => {
  return (
    <>
      <div className="w-[100%] h-[100%] justify-center flex py-10">
        <div className="justify-center flex flex-col text-center">
          ...
          <div className="flex gap-2 py-4">
            <div className="bg-[#1E1F20] flex flex-col justify-between text-white text-sm w-[165px] h-[165px] p-3 text-left  rounded-[12px]">
              <div>Explain how can I get into GDSC</div>
            ...
            <div className="bg-[#1E1F20] flex flex-col justify-between text-white text-sm w-[165px] h-[165px] p-3 text-left  rounded-[12px]">
              <div>Tell me about the members of GDSC</div>
              <div className="flex flex-row-reverse">
            ...
            <div className="bg-[#1E1F20] flex flex-col justify-between text-white text-sm w-[165px] h-[165px] p-3 text-left  rounded-[12px]">
              <div>What is the role of Google within GDSC?</div>
              <div className="flex flex-row-reverse">
            ...
            <div className="bg-[#1E1F20] flex flex-col justify-between text-white text-sm w-[165px] h-[165px] p-3 text-left  rounded-[12px]">
              <div>Tell me about the events that GDSC organises </div>
              <div className="flex flex-row-reverse">
